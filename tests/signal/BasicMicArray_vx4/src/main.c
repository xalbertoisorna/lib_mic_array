...
DECLARE_JOB(host_words_to_app, (chanend_t, chanend_t));
...
int main()
{
  channel_t c_from_host = chan_alloc();
  ...
  PAR_JOBS(
    PJOB(host_words_to_app, (c_from_host.end_a, c_to_app.end_a)),
    PJOB(app_mic, (c_to_app.end_b, c_frames.end_a)),
